          ...
          <VRow>
            ...
            >
              ...
              <p class="text-body-2 text-medium-emphasis mb-0">
                A construtora paga a comissão total ao Portal MeMude (conta a receber). O Portal MeMude retém sua parte e gera uma conta a pagar ao corretor após o recebimento.
              </p>
            </VCol>
            <VCol
              cols="12"
            ...
            >
              ...
              <p class="text-body-2 text-medium-emphasis mb-0">
                O Portal MeMude recebe do comprador (conta a receber) e repassa a parte do corretor (conta a pagar).
              </p>
            </VCol>
            <VCol
              cols="12"
            ...
            >
              ...
              <p class="text-body-2 text-medium-emphasis mb-0">
                O comprador paga diretamente cada parte. O Portal MeMude registra somente sua parte; a parte do corretor fica informativa, sem conta a pagar.
              </p>
            </VCol>
          </VRow>
        </VCardText>
