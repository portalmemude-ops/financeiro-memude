...
-- Completa a trilha de auditoria dos recebiveis legados. As fases anteriores
-- ja haviam criado a transacao de caixa para cada conta recebida, mas ainda nao
-- existia a entidade de baixa. O backfill preserva valor, data e conta originais
-- e vincula a transacao existente, sem duplicar movimentos financeiros.
